...
public class pruebaConexion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConectar.setBackground(new java.awt.Color(0, 204, 204));
        btnConectar.setFont(new java.awt.Font("Courier New", 1, 24)); // NOI18N
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConectarActionPerformed
        ...
        if (cn==null){
            ...
            JOptionPane.showMessageDialog(null, "Felicidades! Se ha establecido la conexion correctamente");
        }
